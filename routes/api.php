...
Route::get('showEntries/{data}/{data2}/{client_id}', [PaletsController::class, 'showEntries']);
...
Route::get('showExpeditions/{data}/{data2}/{client_id}', [PaletsController::class, 'showExpeditions']);
Route::get('showPalExpeditions/{num_albara}', [PaletsController::class, 'showPalExpeditions']);
Route::get('getBloquejats/{client_id}', [BloquejatsController::class, 'getBloquejats']);
Route::get('getBloquejatsEdit', [BloquejatsController::class, 'getBloquejatsEdit']);
...
Route::get('estocAlbara/{num_albara}/{client_id}', [PaletsController::class, 'estocAlbara']);
Route::get('estocLot/{client_id}/{product_id}/{data}', [PaletsController::class, 'estocLot']);
Route::get('consultaSSCC/{num_sscc}/{client_id}', [PaletsController::class, 'consultaSSCC']);
